...
public class crudresource {
	...
	@Path("/retrieveById/{payid}")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public ArrayList<crudmodel> getUser(@PathParam("payid") int payid) throws SQLException {
		return service.getUserById(payid);
	...
	@Path("/deleteUserById/{payid}")
	@DELETE
	@Consumes(MediaType.APPLICATION_JSON)
	public int deleteUser(@PathParam("payid") int payid) {
		return service.deleteUser(payid);
